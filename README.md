...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ua-wppo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ua-wppo.containers.anotherwebservice.com/
...
```
git clone git@github.com:codes254/container-ua-wppo.git
cd container-ua-wppo
```
...
```
docker attach container-ua-wppo
```
